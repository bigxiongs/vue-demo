...
const props = defineProps({ hotType: { type: Number, default: 1, } })
const TITLEMAP = {
  1: '24小时热榜',
  2: '周热榜', 
}
...
const getHotList = async () => goodList.value = (await getHotGoodsAPI({ id: route.params.id, type: props.hotType })).value.result
